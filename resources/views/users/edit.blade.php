                    ...
                    <form method="POST" action="{{ route('users.update', $user) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="role" name="role" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full" required>
                                ...
                                <option value="Team Leader" {{ old('role', $user->role) == 'Team Leader' ? 'selected' : '' }}>Team Leader</option>
                                <option value="CEO" {{ old('role', $user->role) == 'CEO' ? 'selected' : '' }}>CEO</option>
                                <option value="HR Manager" {{ old('role', $user->role) == 'HR Manager' ? 'selected' : '' }}>HR Manager</option>
                            </select>
